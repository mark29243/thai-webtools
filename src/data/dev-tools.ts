...
export const devTools: DevToolDef[] = [
  ...
  },
  {
    ...
    desc: 'สร้าง MAC Address แบบสุ่ม (ใช้สำหรับทดสอบเน็ตเวิร์ก)',
    icon: 'Network',
    placeholder: 'พิมพ์จำนวนบรรทัดที่ต้องการสุ่ม (เช่น 5)',
    action: (t) => {
      let count = parseInt(t) || 1;
  ...
  },
  {
    ...
    desc: 'สร้างหมายเลข IPv4 แบบสุ่ม',
    icon: 'Globe',
    placeholder: 'พิมพ์จำนวนบรรทัดที่ต้องการสุ่ม (เช่น 5)',
    action: (t) => {
      let count = parseInt(t) || 1;
